 ...
 * @author Julio
 */
public class DescricaoFrango extends javax.swing.JFrame {

    /**
     * Creates new form Descricao
     */
    public DescricaoFrango() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Texto.setText("<html>\n• Baixo teor de gordura.<br>\n• Alta concentração de vitaminas<br>\n• Ajuda a promover a saude cardíaca<br>\n• Versatilidade<br>\n• Rico em proteinas aminoacidos<br>\n• Fonte de minerais<br>");
        ...
        ExcTXT.setText("Frango Grelhado");
        getContentPane().add(ExcTXT);
        ExcTXT.setBounds(30, 30, 200, 25);

        ExecucaoTXT.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ExecucaoTXT.setText("<html>\nCalorias--------------159,00kcal<br>\nCarb. Líquidos-----------0,00g<br>\nCarboidratos-------------0,00g<br>\nProteínas-------------------32,00g<br>\nGorduras Totais------------2,50g<br>\nGordutas Saturadas-------0,90g<br>\nFibra Alimentar-----------0,00g<br>\nSódio----------------------50,00g<br>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DescricaoFrango.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DescricaoFrango().setVisible(true);
            }
        });
    }
